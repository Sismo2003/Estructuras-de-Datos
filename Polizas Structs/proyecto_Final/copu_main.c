...
int ans;
    printf("\nIngrese el folio a cambiar: ");
    scanf("%d",&ans);
    if(policyType[ans] == 0){
        printf("Este folio no exite!");
    }
    else{
        if(policyType[ans] == 1){
            int mod =0;
            ...
            switch(mod){
                case 1:
                    printf("\nEl nombre bajo el folio es: %s \n", p[ans].policyOwner.name);
                    printf("\nIngresa el nombre a cambiar: ");
                    scanf("%s", p[ans].policyOwner.name);
                    break;
                case 2:
                    printf("\nEl apellido bajo el folio es: %s \n", p[ans].policyOwner.lastname);
                    printf("\nIngresa el apellido a cambiar: ");
                    scanf("%s",p[ans].policyOwner.lastname);                    
                    break;                
                case 3:
                    printf("\nEl telefono de contacto es: %s \n", p[ans].policyOwner.contactPhone);
                    printf("Ingrese el nuevo numero de telefono:");
                    scanf("%s",p[ans].policyOwner.contactPhone);
                    break;
                case 4:
                    printf("\nEl Email de contacto es: %s \n", p[ans].policyOwner.contactMail);
                    printf("Ingrese el nuevo de correo electronico:");
                    scanf("%s",p[ans].policyOwner.contactMail);
                    break;
                case 5:
                    printf("\nLa dirrecion del contacto es: %s con el numero %s \n", p[ans].policyOwner.addres.street, p[ans].policyOwner.addres.streetNumber);
                    printf("Ingrese el nuevo domicilio:");
                    scanf("%s,%s",p[ans].policyOwner.addres.street, p[ans].policyOwner.addres.streetNumber);
                    break;
                case 6:
                    printf("\nEn la ciudad: %s \n", p[ans].policyOwner.addres.city);
                    printf("Ingrese la nueva ciudad: ");
                    scanf("%s",p[ans].policyOwner.addres.city);
                    break;
                case 7:
                    printf("\nEn el estado: %s \n", p[ans].policyOwner.addres.state);
                    printf("Ingrese el nuevo estado: ");
                    scanf("%s",p[ans].policyOwner.addres.state);
                    break;
                case 8:
                    printf("\nEn el pais: %s \n", p[ans].policyOwner.addres.country);
                    printf("Ingrese el nuevo pais: ");
                    scanf("%s",p[ans].policyOwner.addres.country);
                    break;
                
                case 9:
                    printf("\nLa dirrecion de la poliza es: %s num. #%s \n", p[ans].type.Buissnes.addresInsured.street, p[ans].type.Buissnes.addresInsured.streetNumber);
                    printf("\nIngrese la dirrecion en el mismo formato de la poliza\n");
                    printf("\nIngrese la nueva dirrecion de la poliza: ");
                    scanf("%s,%s",p[ans].type.Buissnes.addresInsured.street, p[ans].type.Buissnes.addresInsured.streetNumber);
                    break;
                
                case 10:
                    printf("\nLa ciudad es:: %s \n", p[ans].type.Buissnes.addresInsured.city);
                    printf("\nIngrese la nueva ciudad de la poliza: ");
                    scanf("%s",p[ans].type.Buissnes.addresInsured.city);
                    break;
                case 11:
                    printf("\nEn el pais: %s \n", p[ans].type.Buissnes.addresInsured.country);
                    printf("\nIngrese el nuevo pais de la poliza: ");
                    scanf("%s",p[ans].type.Buissnes.addresInsured.country);
                    break;
                case 12:
                    printf("\nEn el estado: %s \n", p[ans].type.Buissnes.addresInsured.state);
                    printf("\nIngrese el nuevo estado de la poliza: ");
                    scanf("%s",p[ans].type.Buissnes.addresInsured.state);
                    break;
                default:
                    break;
            }
        ...
        if(policyType[ans] == 2){
            ...
            switch(mod){
                ...
                case 2:
                    ...
                    printf("\nEl apellido bajo el folio es: %s \n", p[ans].policyOwner.lastname);
                    printf("\nIngrese el nuevo apellido de la poliza: ");
                    scanf("%s",p[ans].policyOwner.lastname);
                    break;                
                case 3:
                    printf("\nEl telefono de contacto es: %s \n", p[ans].policyOwner.contactPhone);
                    printf("\nIngrese telefono de la poliza: ");
                    scanf("%s",p[ans].policyOwner.contactPhone);
                    break;
                case 4:
                    printf("\nEl Email de contacto es: %s \n", p[ans].policyOwner.contactMail);
                    printf("\nIngrese la nueva dirrecion de correo electronico de la poliza: ");
                    scanf("%s",p[ans].policyOwner.contactMail);
                    break;
                case 5:
                                       printf("\nIngrese la nueva dirrecion de la poliza: ");
                    scanf("%s",p[ans].policyOwner.addres.street);
                    printf("\nLa dirrecion del contacto es: %s con el numero %s \n", p[ans].policyOwner.addres.street, p[ans].policyOwner.addres.streetNumber);
                    break;
                case 6:
                    printf("\nEn la ciudad: %s \n", p[ans].policyOwner.addres.city);
